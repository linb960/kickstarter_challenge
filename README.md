# Kickstarter Analysis of Outcomes Based on Goals and Launch Date <br>
## Overview of Project
#### This project determines how well Kickstarter Campaigns for theatre projects did based on their launch date as well as outcomes based on funding goals for play productions within the theatre category.<br>
## Analysis and Challenges
To do the analysis the <a href="Kickstarter_Challenge.xlsx">dataset</a> used for this project is Kickstarter data from 2009 to 2017.  Kickstarter helps people fund projects that include categories such as technology, film, music, photography, etc.  So while the data used for this project contains these categories the analysis being done here is based spefically on the "theatre" category and the "plays" subcategory.<br><br>

The initial spreadsheet contained information for each campaign in the following columns:
...
I encountered two challenges.  One was the loss of all of my work on this challenge.  I am using Excel 365 on a MacBook Pro for the first time and didn't know that in order to use autosave I needed to turn it on.  Although it was a challenge it also was helpful in that I gained a better insight into what I was creating. <br><br>
...
The chart shows that for every three theatre campaigns started in May most likely two will be successful.  This leads us to the conclusion that it is best to start a campaign in May.  While May has the greatest number of successes, the months of April, July and August show some success. <br><br>
Therefore we can conclude that the month of May particularly and the other Spring and Summer months tend to be the best time to launch a Theatre Campaign on Kickstarter.  While the month of October shows the greatest number of failures and failures in general tend to stay around the same for each month.  Thus if someone wants to be successful start a campaign in May.
### Conclusions about Outcomes Based on Goal
The fascinating thing about the Outcomes based on goal chart is how the precentage of successful campaigns is a mirror of the failed campaigns.  Where the line begins at close to 80% successful for campaigns looking to raise less than $1000.  As the goal rises the number of failures rise and the number of successes falls.  while it would be easy to leave the analysis at this point we can't overlook the fact that when a goal of somewhere between $35,000 and $45,000 is set the campaign succeeds.  Finding out what this means would require additional analysis of data, including when was the launch date (maybe in May making it more likely to succeed), what country might help and also, since the numbers of the total projects in this range is only 10, what were these plays and how popular are they. <br><br> We can conclude that the more money someone is trying to raise the less likely they are to succeed.  We can also see that once the goal goes over $15,000 the likelihood of failure increases.
### Limitations of Dataset
Some of the limitations are in the question asked in the conclusions based on goal.  While the graph shows a distinctive success in the $35k to $45k range, it's misleading.  There are more then 1000 projects in what we can see as a decline in funding, while only 10 in a rise in funding but just by looking at the chart that's not apparent.  Also, with Kickstarter campaigns there is usually a "giveaway" with higher funding.  So let's say a successful theatre campaign gives away a t-shirt for smaller amounts pledged but box seats for opening night for higher amounts pledged.  The analysis only knows how much was pledged.  If there was a breakdown for pledged amounts based on "giveaway" or other factors than it might be possible to find out if giving away a t-shirt or box seats is a good way to get donors.
...
* Filtering the Theater Outcomes Based on Launch Date by:
  ...
  * Year
  * Subcategory
This would help narrow down factors based on things like how the weather in NZ in the summer months of the US are actually colder and is there a difference in funding based on weather.  Or, how fundraising went in an election year or a year that had a national tragedy in a particular country.  Or just looking at "plays" in both of the sheets.
